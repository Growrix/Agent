export const siteCopy = {
  ...
  "component.footer.address": "Sydney scheduling desk with mobile teams across the metro fringe",
  "component.footer.hours": "Emergency triage 24/7, booked visits Mon-Sat 7:00am-6:00pm",
  "component.footer.license": "NSW Plumbing Contractor Licence 472911C",
  "component.footer.call_label": "Call the team",
  "component.footer.service_area": "Inner West, North Shore, Eastern Suburbs, CBD fringe",
  ...
  "trust.years": "12+ years on Sydney homes",
  "trust.areas": "4 core Sydney coverage zones",
  "trust.response_time": "Same-day triage for urgent jobs",
  "trust.guarantee": "Clear scope, tidy workmanship, photo-ready handover",
  "trust.privacy": "Your details are used only to respond to your plumbing enquiry.",
  "home.hero.eyebrow": "Sydney Plumbing Response",
  "home.hero.headline": "Licensed Sydney plumbers for urgent repairs, drains, and hot water work",
  "home.hero.subheadline": "Harbourline Plumbing pairs fast phone triage with clear quoting for Inner West, North Shore, and Eastern Suburbs homes.",
  "home.hero.cta_primary": "Call Now",
  "home.hero.cta_secondary": "Get a Quote",
  "home.hero.media_alt": "Harbourline plumber beside a stocked service van outside a Sydney terrace home",
  "home.services.heading": "Plumbing services built around the jobs homeowners need most",
  "home.services.body": "Each service block shows urgency, likely inclusions, and the next step so visitors can choose quickly without wading through generic trade copy.",
  "home.proof.heading": "Trusted by households who want fast answers and tidy work",
  "home.proof.body": "Real suburb-specific proof, licensed trade details, and response expectations sit ahead of any hard sell.",
  "home.process.heading": "Simple from first call to completed fix",
  "home.process.body": "Emergency calls get triaged fast, planned jobs get scoped clearly, and every visit is framed around what happens before the van rolls in.",
  "home.coverage.heading": "Built for local response, not generic lead gen",
  "home.coverage.body": "Coverage is explained through Sydney zones, common property types, and realistic arrival language instead of vague metro-wide promises.",
  "home.final_cta.heading": "Need plumbing help now?",
  "home.final_cta.body": "Call for immediate triage or send a concise brief for a same-day callback window.",
  ...
  "services.grid.body": "The service catalogue is written for real homeowner problems: what is failing, how urgent it is, and what the team is likely to inspect first.",
  ...
  "about.hero.headline": "A Sydney plumbing team that feels organised, accountable, and easy to reach",
  ...
  "quote.support.body": "Calling is still the fastest route for burst pipes, no-hot-water failures, and active drainage backups.",
  ...
  "seo.home.meta_title": "Harbourline Plumbing Co. | Sydney Emergency Repairs and Hot Water Help",
  "seo.home.meta_description": "Licensed Sydney plumbers with urgent triage, clear quotes, and suburb-specific proof across the Inner West, North Shore, and Eastern Suburbs.",
...
export type ContentKey = keyof typeof siteCopy;