...
content_keys_used:
  ...
  - seo.terms.meta_title
  - seo.terms.meta_description
  - seo.terms.og_title
  - seo.terms.og_description
---

# Terms (`/terms`)

## 1. Page Definition
- Purpose: Present the site terms in plain language.
- Target user intent: "What are the conditions for using this site?"
...
### 2. Terms Hero
- **Purpose:** Provide title and short summary before the terms text.
- **Content keys:**
  - terms.hero.headline
  - terms.hero.subheadline
...
### 3. Terms Content
- **Purpose:** Render the terms body and last-updated label.
- **Content keys:**
  - terms.body
  - terms.updated_label
...
### 4. Terms Contact CTA
- **Purpose:** Provide a clear next step for terms questions.
- **Content keys:**
  - terms.contact_label
  - global.cta.call_now
...
- Loading: header/footer render after `cms.siteSettings` resolves; main terms sections are static.
...
- Auth: public.
- Offline: static terms remain readable; disable click-to-call if phone is unavailable.
...
```yaml
seo:
  title:        seo.terms.meta_title
  description:  seo.terms.meta_description
  og_title:     seo.terms.og_title
  og_description: seo.terms.og_description
...
## 6. Conversion Path
- primary_path: Terms contact CTA -> Call Now
...
accessibility:
  ...
  heading_outline:
    - h1: terms.hero.headline
    - h2: terms.contact_label
  notable_aria:
...
## 11. Analytics Plan
- Page-view: `page_view` { page_id: "terms" }
- Events:
  - `cta_call_click` { source: "header" | "terms_cta" | "action_bar" }
  - `cta_get_quote_click` { source: "action_bar" }

## 12. Open Questions
- Legal review required for final terms language.
