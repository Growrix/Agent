...
**Command:**
1. `Read DOC/agents/reviewer.agent.md` → extract every constraint id mentioned in WORKFLOW (e.g., `C1..C24`, `F1..F17`, `Q1..Q3`, `CC1..CC6`, `SC1..SC12`, `PC1..PC12`, `DC1..DC11`, `TC1..TCn`, `AC1..AC12`, `I1..I6`).
