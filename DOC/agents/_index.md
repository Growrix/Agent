...
| `frontend_developer` | 1 | Execution (frontend) | frontend planning bundle | `web/` directory tree (Next.js App Router code, components, pages, tokens, content, motion, executable smoke/a11y tests, release-gate scripts, SEO assets, RUN.md, ENV.example, self-audit) |
